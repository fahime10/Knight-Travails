...
/***/ "./src/modules/search-algo.js":
/*!************************************!*\
  !*** ./src/modules/search-algo.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   knightMoves: () => (/* binding */ knightMoves)\n/* harmony export */ });\n/* harmony import */ var _chess_square_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chess-square.js */ \"./src/modules/chess-square.js\");\n\r\n\r\n//Breadth first search\r\nconst knightMoves = (start , end) => {\r\n    _chess_square_js__WEBPACK_IMPORTED_MODULE_0__.squareRegistry.clear();\r\n\r\n    const origin = (0,_chess_square_js__WEBPACK_IMPORTED_MODULE_0__.chessSquare)(...start);\r\n    const target = (0,_chess_square_js__WEBPACK_IMPORTED_MODULE_0__.chessSquare)(...end);\r\n\r\n    const queue = [origin];\r\n    while (!queue.includes(target)) {\r\n        const currentSquare = queue.shift();\r\n\r\n        const enqueueList = currentSquare.possibleKnightMoves();\r\n        enqueueList.forEach((square) => square.setPredecessor(currentSquare));\r\n        queue.push(...enqueueList);\r\n    }\r\n\r\n    const path = [target];\r\n    while (!path.includes(origin)) {\r\n        const prevSquare = path[0].getPredecessor();\r\n        path.unshift(prevSquare);\r\n    }\r\n\r\n    let squareCoord = [];\r\n    path.forEach((square) => {\r\n        squareCoord.push(square.name());\r\n    });\r\n}\n\n//# sourceURL=webpack://knight-travails/./src/modules/search-algo.js?");
